...
use eframe::egui::{self, Color32, InnerResponse, RichText, Ui, WidgetText};
        ...
        match &self {
            LocalRecordData::Sensors(s) => {
                vec![ChartData::new(
                    "RPM sensors".into(),
                    vec![
                        ("N2 raw", s.n2_rpm as f32, Some("RPM"), Color32::from_rgb(0, 0, 255)),
                        ("N3 raw", s.n3_rpm as f32, Some("RPM"), Color32::from_rgb(0, 255, 0)),
                        ("Calculated RPM", s.calculated_rpm as f32, Some("RPM"), Color32::from_rgb(255, 0, 0)),
                    ],
                    Some((0.0, 0.0)),
                )]
            },
            LocalRecordData::Solenoids(s) => {
                vec![
                    ChartData::new(
                        "Solenoid PWM".into(),
                        vec![
                            ("MPC Solenoid", s.mpc_pwm as f32, None, Color32::from_rgb(255,245,0)),
                            ("SPC Solenoid", s.spc_pwm as f32, None, Color32::from_rgb(0,148,222)),
                            ("TCC Solenoid", s.tcc_pwm as f32, None, Color32::from_rgb(232,120,23)),
                            ("Y3 Solenoid", s.y3_pwm as f32, None, Color32::from_rgb(0, 0, 128)),
                            ("Y4 Solenoid", s.y4_pwm as f32, None, Color32::from_rgb(0, 0, 192)),
                            ("Y5 Solenoid", s.y5_pwm as f32, None, Color32::from_rgb(0, 0, 255)),
                        ],
                        Some((0.0, 4096.0)),
                    ),
                    ChartData::new(
                        ...
                        vec![
                            ("MPC Solenoid", s.mpc_current as f32, Some("mA"), Color32::from_rgb(255,245,0)),
                            ("SPC Solenoid", s.spc_current as f32, Some("mA"), Color32::from_rgb(0,148,222)),
                            ("TCC Solenoid", s.tcc_current as f32, Some("mA"), Color32::from_rgb(232,120,23)),
                            ("Y3 Solenoid", s.y3_current as f32, Some("mA"), Color32::from_rgb(0, 0, 128)),
                            ("Y4 Solenoid", s.y4_current as f32, Some("mA"), Color32::from_rgb(0, 0, 192)),
                            ("Y5 Solenoid", s.y5_current as f32, Some("mA"), Color32::from_rgb(0, 0, 255)),
                        ],
                        Some((0.0, 6600.0)),
                    ),
                    ChartData::new(
                        ...
                        vec![
                            ("MPC Solenoid", (s.adjustment_mpc as f32 / 10.0) - 100.0, Some("%"), Color32::from_rgb(255,245,0)),
                            ("SPC Solenoid", (s.adjustment_spc as f32 / 10.0) - 100.0, Some("%"), Color32::from_rgb(0,148,222)),
                        ],
                        Some((-100.0, 100.0)),
                    )
                ]
            ...
            LocalRecordData::Canbus(s) => {
                ...
                ChartData::new(
                    "Wheel speeds".into(),
                    vec![
                        ("Rear left wheel", s.left_rear_rpm as f32, Some("RPM"), Color32::from_rgb(0, 255, 0)),
                        ("Rear right wheel", s.right_rear_rpm as f32, Some("RPM"), Color32::from_rgb(0, 0, 255)),
                    ],
                    None,
                )]
            },
            LocalRecordData::SysUsage(s) => {
                ...
                vec![ChartData::new(
                    "CPU Usage".into(),
                    vec![
                        ("Core 1", s.core1_usage as f32 / 10.0, Some("%"), Color32::from_rgb(0, 255, 128)),
                        ("Core 2", s.core2_usage as f32 / 10.0, Some("%"), Color32::from_rgb(255, 0, 128)),
                    ],
                    Some((0.0, 100.0)),
                ),
                ChartData::new(
                ...
                ChartData::new(
                    "OS Task count".into(),
                    vec![
                        ("Count", s.num_tasks as f32, None, Color32::from_rgb(0, 255, 0)),
                    ],
                    None
                )]
            },
            ...
            LocalRecordData::ClutchSpeeds(s) => {
                vec![ChartData::new(
                    "RPMs".into(),
                    vec![
                        ("K1", s.k1 as f32, Some("RPM"), Color32::from_rgb(0, 64, 0)),
                        ("K2", s.k2 as f32, Some("RPM"), Color32::from_rgb(0, 128, 0)),
                        ("K3", s.k3 as f32, Some("RPM"), Color32::from_rgb(0, 255, 0)),
                        ("B1", s.b1 as f32, Some("RPM"), Color32::from_rgb(255, 0, 0)),
                        ("B2", s.b2 as f32, Some("RPM"), Color32::from_rgb(255, 128, 0)),
                        ("B3", s.b3 as f32, Some("RPM"), Color32::from_rgb(255, 255, 0)),
                    ],
                    None,
                )]
            },
