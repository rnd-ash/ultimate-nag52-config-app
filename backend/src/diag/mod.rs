...
impl Nag52Diag {
    ...
    pub fn with_kwp<F, X>(&mut self, mut kwp_fn: F) -> DiagServerResult<X> where F: FnMut(&mut Kwp2000DiagnosticServer) -> DiagServerResult<X>  {
...
pub mod test_diag {
    ...
    use crate::{hw::usb_scanner::Nag52UsbScanner, diag::{AdapterHw}};
